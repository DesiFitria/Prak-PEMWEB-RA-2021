...
<body>
    ...
    <script>
        function hRender() {
            const buck = document.getElementById("historii")
            let template = ''
            console.log('foo')

            if (localStorage.arr0fHyst !== null) {
        ...
        function addHist(el) {
            ...
            const isi = el.getElementsByClassName('card-head')[0].innerText
            ...
            if (localStorage.getItem('arr0fHyst') !== null) {
                ...
                localStorage.setItem('arr0Hyst', JSON.stringify(histories))
            } else {
                localStorage.setItem('arr0Hyst', JSON.stringify(['hyst' + id]))
            }
